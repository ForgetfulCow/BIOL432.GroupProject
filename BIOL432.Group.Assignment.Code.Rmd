...
There are 13 species of Ladybeetle documented in this study. 9 species are native, while the remaining 4 are non-native invase species. All species analyzed are aphidophagous coccinellids, so they share a similar food base.
...
# Use ggplot for Graphical Analysis
...
# Use Trees for Cluster Analysis
...
### Subset by habitat type (to address research question 2)
...
### Subset the habitat types by time period (to address research question 3)
...
There is no distinct clustering of native and non-native ladybeetle species in the first two time periods for perennial habitat data. However, in the 1999 - 2006 (C) and 2007 - 2012 (D) time periods there does appear to be some segregation between native and non-native species. In 1999 - 2006 only *C. septempunctata* and *H. axyridis* segregate separately from the other species, while the third invasive species is in a separate cluster. In 2007 - 2012 all the non-native species are in the same cluster along with a couple native species. 3 other native species (*H. glacialis*, *C. maculata*, and *H. convergens*) segregate away from the non-native cluster. The remaining native species are not present in this subset (see below).

```{r}
# For perennial habitat, 2007 - 2012 (D) subset, count the total amount of log-transformed abundances for each species
# Note that the native species H. trifasciata and C. stigma are not present in this subset
T4.P.AbunSum %>% group_by(SpeciesID) %>% summarise(tot = sum(SumAbun))
```
...
We used graphical and tree clustering analysis to analyze a long-term detaset on ladybeetle abundance in order to determine how ladybeetle abundance changes seasonally and whether niche partitioning is occurring between native and non-native ladybeetles.

  - Abundance generally changes seasonally in all habitats for both native and non-native species, except for native species in forest habitat

  - In perennial and forest habitat, we see little to no evidence of niche partioning
  
  - In annual habitat, we see evidence of temporal niche partitioning ~2/3 of the way through the year, where there is a concurrent decline of non-native abundance and increase of native abundance
  
  - Niche partitioning and seasonal abundance patterns do seem to be affected by the introduction of non-native species, both competitors (other ladybeetles) and prey (aphids)
        - Specifically, aphid outbreaks may "break" patterns of niche partitioning, potentially by stopping food from becoming a limiting resource
              - In graph C of the time series, native and non-native species increase at the same time 2/3 of way through the year
        - This may be due to changing patterns of competitive interactions resulting in plastic or evolutionary (unlikely) shifts in temporal activity
                - *Note: If you guys have other alternative hypotheses, feel free to add them

Arjun:

- The trees corroborate the graphs' finding that for the most part, there is little to no temporal paritioning between native and non-native ladybeetle species

- The weak segregation between native and non-native species on the tree for annual habitats supports Cameron's finding of some temporal niche partitioning in annual habitats

- the weak segregation between native and non-native species on the tree for annual habitats in the time periods of 1994 - 1998 and 2007 - 2012 corresponds with the weak recipricol increases and decreases of native and non-native species in the same subsets in the time-series graph

- the finding in the trees for perennial habitat during the final 2 time periods (1999 - 2006 and 2007 - 2012) of some support for temporal partitioning between native and non-native does not match Cameron's findings. On the time-series graphs, the abundance of native species is a flat line and does not change with time, suggesting no response to non-native ladybeetle abundance
...
# Conclusion 
  ...
  Using graphical analysis on adult abundance, we found that abundance changes with time for both native and non-native species, except for native species found in the forest habitat. Seasonal variation in abundance may reflect environmental changes. For example, activity levels of ladybeetles may vary with temperature, increasing or decreasing each species' risk of being trapped at different times of the year. This may explain seasonal differences in abundance in any one ladybeetle species, but is unlikely to account for reciprocal increases and decreases between native and non-native species.
  
  Across the perennial and forest habitat, graphical analysis found little to no evidence for temporal niche partitioning between native and non-native ladybeetles. In contrast, cluster analysis indicates that temporal niche partitioning may occur in the perennial habitat during the final 2 time periods (1999 - 2006 and 2007 – 2012). NOT SURE WHAT TO CONCLUDE HERE: (Arjun and Amanda suggest the below:)
  
Arjun:
  The cluster analysis may have captured temporal partitioning between non-native species and just a few native species. It is possible that the graph for these subsets did not capture changes in abundance for certain native species because all the native species were pooled together, so noise from other native species might have masked changes in abundance in a few native species.

Amanda:
  Further research may be needed to clarify whether temporal niche partitioning between native and non-native ladybeetles occurs in perennial habitats. 
  
  
  
  Within the annual habitat, which is a rotating monoculture, evidence for temporal niche partitioning was found using both graphical and cluster analysis. An increase in native species abundance and a concomitant decline in non-native species abundance suggests temporal niche partitioning ~2/3 of the way through the year. Using cluster analysis, the weak segregation between native and non-native species on the tree for annual habitats in the time periods of 1994 - 1998 and 2007 - 2012 corresponds with the weak reciprocal increases and decreases between native and non-native species for the same subsets in the abundance graph. It is interesting to note that niche partitioning only appears to occur during a limited time throughout the year. These results suggest that species-species interactions and competitive exclusion only influences abundance at a certain time of year. Food preference and availability may overlap during this period of time and increase interactions between native and non-native species.

  This study was able to build off of the results of previous researchers and provide a better understanding of how native and non-native ladybeetles coexist.  Understanding species-species interactions and abundance variation is important in order to properly manage invasive ladybeetles. 
