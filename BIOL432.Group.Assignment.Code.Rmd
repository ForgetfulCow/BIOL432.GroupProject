...
We tested the effect of switching between log-transformed and raw abundance data for the forest tree (including all years). There was little effect on the tree topology, but for the raw abundance data 2 of the non-native species (*C. septempunctata* and *H. axyridis*) became closer to each other, probably reflecting their high abundance relative to most of the other species (data not shown).

Below, we present the analyses using the log5(x+1) transformation of the abundance data, as it appears to have at least slightly limited the impact highly abundant species.
