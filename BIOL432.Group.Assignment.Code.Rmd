...
1. **H0**: Native and non-native species abundance does not change according to the month within sampling years. **H1**: Native and non-native species abundance does change according to the month within sampling years. 

2. **H0**: There is not temporal niche partitioning among native species and among non-native species. There is not temporal niche partitioning between native and non-native species. **H1**: There is temporal niche partitioning among native species and among non-native species. There is temporal niche partitioning between native and non-native species. 

3. **H0**: There is not a change in seasonal partitioning before and after invasive species arrive. **H1**: There is a change in seasonal partitioning before and after invasive species arrive. 

\n 

**Predictions for each question:** 

1. If environmental factors that vary seasonally affect native and non-native species abundance, then native and non-native species abudnance may change according to the month within sampling years. 

2. If native species compete with non-native species, then native and non-native species may have temporal niche partitioning among and/or between them. 

3. If invasive species (soybean aphid) impact native or non-native species' success, then there may be a change in seasonal partiioning before, during, and after its arrival. 
