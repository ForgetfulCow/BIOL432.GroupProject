...
# Mean Adult abundance across the entire study
```{r}
dat %>% 
  group_by(SpeciesID) %>% 
  summarise(MeanAbundance = n())
```
The most common species caught over the duration of the study was the native species; Seven-spot ladybeetle (Coccinella septempunctata)  and Spotted Lady Beetle (Coleomegilla maculata) and non native specie; Harlequin/Asian ladybeetle (Harmonia axyridis). 
...
# Notice that many of the native speciesthat appear to segregate separately from the non-native species actually have little to no presence in this subset
